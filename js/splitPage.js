...
function mak_Link(oTbl, tblHeadRowCount, nowPage)
{
	...
	str += "共"+ totalRowCount + "条记录<ul class=\"pagination\">" ;
	str += "<li><input type=\"hidden\" name=\"nowPageIpt\" id=\"nowPageIpt\" value=\""+nowPage+"\" />" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"first\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>首页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"pre\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>前页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"next\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>后页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"last\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>尾页</a></li>" ;
	str += "<li><input type=\"text\" name=\"tzIpt\" id=\"tzIpt\" value=\""+nowPage+"\" " +
				   "onkeyup=\"this.value=this.value.replace(/\\D/g,\"\")\" " +
				   "title=\"请输入有效数字  \" style=\"width:30px;height:34px;\" /> 共"+pageCount+"页" ;
	str += "<a href=\"javascript:void(0)\" onclick=changePage(\"tiaozhuan\",\"tzIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>跳转</a></li>" ;
	str += "</span>" ;
	return str ;
}
...
function mak_Link2(oTbl, tblHeadRowCount, nowPage)
{
	...
	str += "共"+ totalRowCount + "条记录&nbsp;&nbsp;<ul class=\"pagination\">" ;
	str += "<li><input type=\"hidden\" name=\"nowPageIpt\" id=\"nowPageIpt\" value=\""+nowPage+"\" />" ;
	str += "<a href=\"javascript:void(0)\" onclick=changePage(\"first\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>首页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"pre\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>前页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"next\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>后页</a></li>" ;
	str += "<li><a href=\"javascript:void(0)\" onclick=changePage(\"last\",\"nowPageIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>尾页</a></li>" ;
	str += "<li><input type=\"text\" name=\"tzIpt\" id=\"tzIpt\" value=\""+nowPage+"\" " +
				   //"onkeyup=\"this.value=this.value.replace(/\\D/g,\"\")\" " +
				   "title=\"请输入有效数字  \" style=\"width:30px;height:34px;\" /> 共"+pageCount+"页" ;
	str += "<a href=\"javascript:void(0)\" onclick=changePage(\"tiaozhuan\",\"tzIpt\",\""+oTbl.id+"\",\""+tblHeadRowCount+"\")>跳转</a></li></ul>" ;
